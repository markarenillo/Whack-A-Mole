...
public class Scores{
    ...
    public Scores(Stage stage, Scene scene){
    	//create about scene
    	
    	this.stage = stage;
    	this.primaryScene = scene;
    	this.scorePane = new Pane();
    	this.scene = new Scene(this.scorePane, 768, 460.8);
    	//set scene size, initialize pane

        this.background= new BackgroundImage(new Image("images/scorelist.jpg"), BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT, new BackgroundSize(768, 460.8, true, true, true, true));
        this.scorePane.setBackground(new Background(background));
        ...
        //on the scene.
        this.scorePane.getChildren().add(this.arrowBack);
